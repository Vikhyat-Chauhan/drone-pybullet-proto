...
# push_pose(x, y, z, t) replaces the ROS pose-subscription callback;
# experiment/orchestrator.py's drive loop calls it once per sim tick.
# load_rects()/point_in_rect() and the visit-counting state machine are
# ported verbatim.
