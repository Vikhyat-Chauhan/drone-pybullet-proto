...
# E = EPM[J/m] * horizontal_distance. Node/subscription plumbing
# stripped; push_pose(x, y, z, t) replaces the ROS pose-subscription
# callback -- caller (main.py drive loop) calls it once per sim tick,
# with t taken from SimClock rather than a ROS PoseStamped header stamp.
